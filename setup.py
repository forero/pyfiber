...
#
setup_keywords['name'] = 'pyfiber'
setup_keywords['description'] = 'Fiber assignment package'
setup_keywords['author'] = 'Jaime Forero-Romero'
setup_keywords['author_email'] = 'je.forero@uniandes.edu.co'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/forero/pyfiber'
#
